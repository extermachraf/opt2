-- Location: supabase/migrations/20251006120000_final_fix_must_questionnaire_metadata_error.sql  
-- Schema Analysis: Fix metadata column error in MUST questionnaire migration
-- Integration Type: Modificative - Fix column error and ensure proper MUST questionnaire structure
